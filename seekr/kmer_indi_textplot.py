...
#                    seqfontsize=72, numfontsize=40, colorblockh=0.2, outputpath='', plotformat='pdf', plotdpi=300)
...
def kmer_indi_textplot(seqfile, words, color_vec='default', wraplen=60, char_spacing=0.1, line_spacing=0.2,
                       seqfontsize=72, numfontsize=40, colorblockh=0.2, outputpath='', plotformat='pdf', plotdpi=300):
    ...
    for seq, plotname in zip(seqs, plotnames):
        ...
        fig, ax = plt.subplots(figsize=(wraplen/4, max_total_lines*0.5))  # 3 rows for each line

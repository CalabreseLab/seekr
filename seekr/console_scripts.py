...
wrap length is 60 characters and the textplot is saved as comp_textplot.pdf under current directory
    ...
    $ seekr_kmer_comp_textplot seq1.fa seq2.fa 'ATTA,AAAA,ACTC' -cv '#d62728,#e377c2,#ff7f0e' -wl 60 -cs 0.1 -ls 0.2 -sfs 42 -nfs 40 -cbh 0.15 -o comp_textplot -pf pdf -d 300
...
under the directory: /Users/username/Desktop/indi_textplot/, in pdf format with 300 dpi
    ...
    $ seekr_kmer_indi_textplot seq.fa 'ATTA,AAAA,ACTC' -cv '#d62728,#e377c2,#ff7f0e' -wl 60 -cs 0.1 -ls 0.2 -sfs 72 -nfs 40 -cbh 0.2 -op /Users/username/Desktop/indi_textplot/ -pf pdf -d 300
...
def console_kmer_comp_textplot():
    ...
    parser.add_argument("-sfs", "--seqfontsize", default=72, help="sequence character font size.")
...
def console_kmer_indi_textplot():
    ...
    parser.add_argument("-sfs", "--seqfontsize", default=72, help="sequence character font size.")
    parser.add_argument("-nfs", "--numfontsize", default=40, help="sequence position number font size.")
    parser.add_argument("-cbh", "--colorblockh", default=0.2, help="height of the highlight color block.")
    parser.add_argument(
        "-op", 
        "--outputpath", 
        default="",

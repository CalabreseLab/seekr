...
the corresponding nodes and edges files will be saved as testdata_nodes_leiden.csv and testdata_edges_leiden.csv under current directory
    ...
    $ seekr_kmer_leiden ldseq.fa mean_4mer.npy std_4mer.npy 4 -a RBERVertexPartition -r 1.0 -pco 0.1 -sd -ec gradient -et 0.1 -lfs 12 -o test -s testdata

to save under other location change to -o /Users/username/Desktop/test
to suppress plotting, leave out -o and its argument
to suppress saving nodes and edges files, leave out -s and its argument

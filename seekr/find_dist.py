...
# plotfit example: plotfit = 'testplot.pdf' or '/Users/username/Desktop/testplot.png'
# outputname: full path of the output csv file, default is None, which means not save the output to a csv file
# outputname example: 'test' or '/Users/username/Desktop/test', a trailing part _fitres.csv will be added to the outputname
...
def find_dist(inputseq='default', k_mer=4, log2='Log2.post', models='common10', subsetting=True, subset_size = 100000, fit_model=True, statsmethod='ks',progress_bar=False, plotfit=None, outputname=None):
    ...
    if fit_model:
        ...
        if outputname:
            ...
            results_df.to_csv(f'{outputname}_fitres.csv', index=False)
        ...
        if outputname:
            ...
            np.savetxt(f'{outputname}_fitres.csv', sim_triu, delimiter=",")

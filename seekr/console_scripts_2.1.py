...
def console_kmer_indi_textplot():
    ...
    parser.add_argument("-wl", "--wraplen", default=60, help="how many words to wrap in each line.")
    parser.add_argument("-cs", "--char_spacing", default=0.1, help="space between characters in the plot.")
    parser.add_argument("-ls", "--line_spacing", default=0.3, help="line space between seq1, seq2 and number.")
    parser.add_argument("-sfs", "--seqfontsize", default=72, help="sequence character font size.")
    parser.add_argument("-nfs", "--numfontsize", default=40, help="sequence position number font size.")
    parser.add_argument("-cbh", "--colorblockh", default=0.3, help="height of the highlight color block.")
    parser.add_argument(
        "-op", 
        "--outputpath", 
        default="",

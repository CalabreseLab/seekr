...
# save_file: whether to save the output dataframe to a csv file, default is True
# outputname: the name of the output file, default is 'testpval.csv'
# progress_bar: whether to show the progress bar during p value caculation, default is True
...
# pvals=find_pval(seq1file='test1.fa', seq2file='test2.fa', mean_path='bkg_mean_4mers.npy', std_path='bkg_std_4mers.npy', k_mer=4, fitres=fitres, log2='Log2.post', bestfit=1, save_file=True, outputname='testpval.csv', progress_bar=True)
...
def find_pval(seq1file, seq2file, mean_path, std_path, k_mer, fitres, log2='Log2.post', bestfit=1, save_file=True, outputname='testpval.csv', progress_bar=True):

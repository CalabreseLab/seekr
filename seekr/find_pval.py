...
# outputname: full path of the output file, default is 'test' under current directory, the trailing part _pval.csv will be automatically added
# outputname: another example: '/Users/username/Desktop/test'
# outputname can be set to: outputname = None, if you don't want to save the output to a csv file
...
def find_pval(seq1file, seq2file, mean_path, std_path, k_mer, fitres, log2='Log2.post', bestfit=1, outputname='test', progress_bar=True):

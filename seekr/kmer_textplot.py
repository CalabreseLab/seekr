...
# outpoutname: the name of the output file, default is 'test'
# outputpath: the path of the output file, default is current working directory, example: '/Users/username/Desktop/'
...
#               seqfontsize=52, numfontsize=40, outputname='test', outputpath='', plotformat='pdf', plotdpi=300)
...
def kmer_textplot(seq1file, seq2file, words, color_vec='default', wraplen=60, char_spacing=0.1, line_spacing=0.2, 
                  seqfontsize=42, numfontsize=40, outputname='test', outputpath='', plotformat='pdf', plotdpi=300):
    ...
    if plotformat in formatlist: 
        plt.savefig(f'{outputpath}{outputname}_kmer_textplot.{plotformat}', format=plotformat, dpi=plotdpi, bbox_inches='tight')
    else: 
        print("plotformat not supported. use default 'pdf' now. other common formats are: 'png', 'jpg', 'svg', 'eps', 'tif', 'tiff', 'ps', 'webp'")
        plt.savefig(f'{outputpath}{outputname}_kmer_textplot.pdf', format='pdf', dpi=plotdpi, bbox_inches='tight')

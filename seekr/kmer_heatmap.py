...
# outputname: the path and name to save the output heatmap, will automatically be combined with the trailing part _kmer_heatmap. 
# outputname Default, 'test', is current working directory file: test_kmer_heatmap, another example is '/Users/username/Desktop/test'
...
def kmer_heatmap(df, datamin, datamax, thresh_value=0.05,
    ...
    #plt.savefig(f'{outputname}_kmer_heatmap.{hformat}', format=hformat, dpi=hdpi, bbox_inches='tight')
    ...
    if hformat in formatlist: 
        ...
        plt.savefig(f'{outputname}_kmer_heatmap.pdf', format='pdf', dpi=hdpi, bbox_inches='tight')

...
### Example:
# kmer_comp_textplot(seq1file='test1.fa', seq2file='test2.fa', words=['TAAA','GGTG','TCCA','GGTG','ACCT','ATAC','AGAC','GTCC','TTTT','ACCT'], 
#                    color_vec='default', wraplen=60, char_spacing=0.1, line_spacing=0.2,
#                    seqfontsize=72, numfontsize=40, colorblockh=0.15, outputname='comp_textplot', plotformat='pdf', plotdpi=300)
...
def kmer_comp_textplot(seq1file, seq2file, words, color_vec='default', wraplen=60, char_spacing=0.1, line_spacing=0.2,
                       seqfontsize=72, numfontsize=40, colorblockh=0.15, outputname='comp_textplot', plotformat='pdf', plotdpi=300):

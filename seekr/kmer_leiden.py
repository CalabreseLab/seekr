...
# outputname: the name and path of your output file, default is None, which suppress the plotting and only get the nodes and edges csv file (if savecsv=True)
# outputname other example: 'test' this will broadcast to all saved images (pdf) and csv files

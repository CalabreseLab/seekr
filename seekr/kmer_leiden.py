...
# plotname example: 'test' this will broadcast to all saved images
# plotname will be added a trailing part _gradient_leiden_network.pdf or _threshold_leiden_network.pdf based on the edgecolormethod
# plotname can be set to another folder: '/Users/username/Desktop/test'
...
### output:
# a pdf file (plotname_gradient_leiden_network.pdf or plotname_threshold_leiden_network.pdf) of the Leiden community network
...
def kmer_leiden (inputfile, mean, std, k, algo='RBERVertexPartition', rs=1.0, 
    ...
    if plotname:
        ...
        if edgecolormethod == 'gradient':
            ...
            # Save the figure
            plt.savefig(f'{plotname}_gradient_leiden_network.pdf')
            ...
            # Save the figure
            plt.savefig(f'{plotname}_threshold_leiden_network.pdf')

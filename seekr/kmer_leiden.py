...
# seed: if set to an integer, like 1, community detection results would be reproducible. 
# seed default is None, in which case, the results would not be reproducible when the same code run multiple times. This can be used to test the robustness of the detected communities.
